...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-certiflow-production-auto-fallback-key-please-change-in-env')
...
# CertiFlow Custom Settings
QR_REFRESH_INTERVAL = config('QR_REFRESH_INTERVAL', default=20, cast=int)  # seconds
